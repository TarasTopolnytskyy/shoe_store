# Generated by Django 2.2 on 2019-12-18 14:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shipping_info', to='login_register_app.User')),
            ],
        ),
        migrations.AddField(
            model_name='inventory',
            name='buyer',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='bought', to='login_register_app.User'),
        ),
        migrations.AddField(
            model_name='inventory',
            name='seller',
